...
public class RabbitMQService : IRabbitMQService
{
    ...
    /*public async Task<List<Produit>> GetProduitsByIds(List<int> produitIds)
    {
        ...
        try
        {
            ...
            var response = await SendMessageAndWaitForResponseAsync(produitIdsString, "produitInCommande","channel_commande_produit_details");
            Console.WriteLine("RESPONSE",response);
       
            var produits = JsonSerializer.Deserialize<List<Produit>>(response, new JsonSerializerOptions
            {
